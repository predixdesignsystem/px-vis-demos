...
function runBaseTests() {
  px_vis_demos_1 = document.getElementById('px_vis_demos_1');

  suite('Base Automation Tests for px-vis-demos', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-demos fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_demos_1') !== null);
    });
